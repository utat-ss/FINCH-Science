...
def run_rfmo_model(target_abundances=['gv','soil'], graph = True, n_estimators= 200, 
    ...
    #This function runs the whole multi-output regressor model with the specified target abundances (npv is always present). You also have the option of graphing the true vs. predicted plots.
...
def ds_preparation(target_cols, file = '/Users/joshuasmacbookair/Desktop/UTAT/simpler_data.csv', wavelength_lim= [900,1700], test_size=0.25):   
    ...
    # Split the dataset into training and testing sets (75% train, 25% test, can change it)
